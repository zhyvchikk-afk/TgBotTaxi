...
async def price(message: Message):
    await message.answer(
        ...
        f"ви нас вже знаєте...\nАле ми трішки змінилися\n"
        f"У нас купа переваг! Із них:\n"
        f"▪️Швидкість замовлення авто.🚀 Заходимо в ТГ, тиснемо кнопку 'Замовити', Готово!\n"
        f"▪️Тут не можуть не взяти трубку.💯 Ви 100% замовите авто!\n"
        f"▪️Диспетчер не в настрої, а після розмови з ним - і ви теж?.🤬 Забудьте. Дзвінки на крайній випадок\n"
        f"▪️Не потрібно скачувати новий додаток. Це особливий ➕ коли немає місця на телефоні!\n"
        f"▪️Ми маємо фішки яких не мають інші служби! Рейтинг, оцінювання...⭐️ А скоро буде ще більше\n"
        f"▪️Це об'єктивно новий підхід до сервісу в нашому місті!🪅\n"
...
#Отримання 🆔
@router.message(F.text == 'Отримати свій 🆔')
async def get_id(message: Message):
    user_id = message.from_user.id
    await message.answer(f'Цей 🆔 потрібен для реєстрації в базі водіїв.\n'
                         f'<b>{user_id}</b>\n',
                         ...
                         f'Його передача ніяк не впливає на порушення безпеки Ваших.\n',
                         f'особистих данних!.\n',
                         )
